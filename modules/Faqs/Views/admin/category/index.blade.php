...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"> Faqs Categories</h1>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 mb40">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form action="{{route('faqs.admin.category.store',['id'=>-1])}}" method="post">
                            @csrf
                            @include('Faqs::admin/category/form',['parents'=>$rows])
                            <div class="">
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        @if(!empty($rows))
                            <form method="post" action="{{url('admin/module/faqs/category/bulkEdit')}}"
                    ...
                    <div class="col-left">
                        <form method="get" action="{{url('/admin/module/faqs/category/')}} " class="filter-form filter-form-right d-flex justify-content-end" role="search">
                            @csrf
                            ...
                            <table class="table table-hover">
                                ...
                                @if(count($rows) > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td class="title">
                                            <a href="{{url('admin/module/faqs/category/edit/'.$row->id)}}">{{$prefix.' '.$row->name}}</a>
                                        </td>
                                        <td>{{$row->slug}}</td>
