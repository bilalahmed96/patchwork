...
@section('content')
    <form action="{{route('faqs.admin.tag.store',['id'=>$row->id])}}" method="post">
        @csrf
        <div class="container">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    ...
                    @if($row->slug)
                        <p class="item-url-demo"> {{ __('Permalink:')}} {{url('faqs/tag')}}/<a href="#" class="open-edit-input" data-name="slug">{{$row->slug}}</a>
                        </p>
                    @endif
                </div>
                <div class="">
