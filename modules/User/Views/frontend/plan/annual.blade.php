            ...
            <div class="row margin-bottom-50 justify-content-center single-package">
             ...
             <div class="col-xl-10">
                  <h3 class="plan-heading"> 
                               Annual Partner Package Features
                            </h3>
                              <div class="plan-body">
                        ...
                        <div class="feature-list">
                            ...
                            <ul class="">
                                ...
                                <li>
                                    <img src="https://stagging.patchworkhub.org/templates/classic-theme/images/Tick.png" alt="Patchwork Images">
                                   <span class="fw-bold" style=""> 2 free featured jobs<span> per month</span> </span>
                                </li>
                                ...
                                <li>
                                 ...
                                 <li>
                                    <img src="https://stagging.patchworkhub.org/templates/classic-theme/images/Tick.png" alt="Patchwork Images">
                                    <span class="fw-bold" style=""> Use of Logo -  <span style="font-weight: normal"> use our badged Partner logo on your correspondence and websites to showcase your commitment to accessibility</span> </span>
                                </li>
                            ...
                            <ul>
                                 <li>
                                    <img src="https://stagging.patchworkhub.org/templates/classic-theme/images/Tick.png" alt="Patchwork Images">
                                     <span class="fw-bold" style=""> Free In-House Disability Awareness Training session</span> 
                                </li>
                                ...
                                <li>
                                    <img src="https://stagging.patchworkhub.org/templates/classic-theme/images/Tick.png" alt="Patchwork Images">
                                     <span class="fw-bold" style=""> Free Inclusive Recruitment Training session</span> 
                                </li>
                        ...
                        <div class="price-list">
                            <ul>
                                <li>
                                    ...
                                    <span class="fw-bold" style="">Featured ad</span> fee <span class="fw-bold" style="">£17 </span> for 10 days
                                </li>
                                
                                <li>
                                    <i class="fas fa-plus"></i>
                                    <span class="fw-bold" style="">Urgent ad</span> fee <span class="fw-bold" style="">£9 </span> for 14 days
                                </li>
                                
                                <li>
                                    <i class="fas fa-plus"></i>
                                    <span class="fw-bold" style="">Highlight ad</span> fee <span class="fw-bold" style="">£5 </span> for 7 days
                                </li>
                            </ul>
                        </div>
