                ...
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <div class="panel">
                                        ...
                                        <div class="col-md-6" >
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-append">
                                                        <select class="form-control" name="job_locations">
                                                            <option value="" @if(old('work_location', $row->work_location) == '') selected @endif > -- </option>
                                                            <option value="Fully remote" @if(old('work_location', $row->work_location) == 'Fully remote') selected @endif >{{ __("/day") }}</option>
                                                            <option value="Remote based" @if(old('work_location', $row->work_location) == 'Remote based') selected @endif >{{ __("/week") }}</option>
                                                            <option value="Onsite or Office based" @if(old('work_location', $row->work_location) == 'Onsite or Office based') selected @endif >{{ __("/month") }}</option>
                                                            <option value="Remote and/or Onsite" @if(old('work_location', $row->work_location) == 'Remote and/or Onsite') selected @endif >{{ __("/year") }}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <label class="mt-2">
                                                 ...
                                                 <label class="mt-2">
                                                    <input type="checkbox" name="negotiable" @if(old('negotiable', $row->negotiable)) checked @endif value="1" /> Negotiable
                                                </label>
                                                
                                                 <label class="mt-2">
                                                    <input type="checkbox" name="minimum_wage" @if(old('minimum_wage', $row->minimum_wage)) checked @endif value="1" /> Minimum Wage
                                                </labelminimum_wage
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                         ...
                         <div class="panel">
                                <div class="panel-title"><strong>Screen Questions</strong></div>
                                <div class="panel-body">

                                    <div class="form-group">
                                        <label class="control-label">Add Screening Questions</label>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <br>
                                        <label>
                                            <input type="checkbox" name="is_highlight" @if(old('is_highlight',$row->is_highlight)) checked @endif value="1"> Enable Highlight
                                        </label>
                                    </div>
                                </div>
                            </div>
...
@section ('script.body')
    ...
    <script>
        ...
        $('body').on('click','.addQuestion',function(){
            ...
            var newRow = $('<tr>' +
                    '<td  class="text-light">'+
                     '<input style="margin-top: 15px" class="form-control" type="text" name="question[]" id="question" placeholder="Question '+ counter +'">'+
                     '</td>'+
                     '<td style="text-align: center;">'+
                     '<button style="margin-right:10px" class="save button hak-save-button ripple-effect" type="button">Ok</button>'+
                     '<button class="removepur button hak-remove-button ripple-effect" type="button">Remove</button>'+
                    '</td>'+
            '</tr>');
            $('#questionBody').append(newRow);
            $('#askQ').attr('style', 'display: block !important')
        });

         $('body').on('click','.removepur',function(){
         ...
         $('body').on('click','.save',function(){
             ...
             console.log(row)
             var questionButton = $(row.find('.save')).hide(); 
             var question = $(row.find('#question')).css({"pointer-events":"none", "background-color":"grey", "color":"#FFF"}); 
