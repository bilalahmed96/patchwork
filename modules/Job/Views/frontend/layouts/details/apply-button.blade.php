        ...
        @switch($row->apply_type)
            ...
            @default
                ...
                @else
                    ...
                    @else
                        <a href="#" data-require-text="{{ __('Please login as "Candidate" to apply') }}" class="theme-btn btn-style-one bc-apply-job-button @if(!is_candidate() ) bc-require-candidate-apply @else bc-call-modal apply-job @endif">{{ __("Apply For Job") }}</a>
                    @endif
