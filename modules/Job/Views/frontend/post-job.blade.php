    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-md-12">
                ...
                <form id="post_job_form" class="hak-form-3" action="{{ route('job.post') }}" method="post" enctype="multipart/form-data" >
                                            ...
                                            <div class="col-xl-12">
                                             ...
                                             <div class="col-xl-12">
                                                ...
                                                <div class="checkboxes square">
                                                    ...
                                                    <input type="checkbox" id="minimum_wage" name="minimum_wage" value="1">

                                                    <label for="minimum_wage"><span class="checkbox-icon"></span> Minimum Wage</label>
...
<br>
 ...
 <div class="form-group text-center">
                                        ...
                                        <a data-toggle="modal" data-target="#exampleModal" role="button" id="choose-category" class="button  dark-btn dark-title" style="font-family: 'comfortaa !important; "><i class="icon-feather-check-circle"></i>

                                            &nbsp;Choose Category</a>

                                    </div>

                                    <div class="form-group selected-product text-center" id="change-category-btn" style="display: none">
                                        ...
                                        <ul class="select-category list-inline">
                                            ...
                                            <li class="active"><a data-toggle="modal" data-target="#exampleModal" role="button"  class="" style="color: rgb(64, 20, 102)"><i class="fas fa-edit"></i> Edit</a></li>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="tg-category  col-md-3"   data-cat-name="{{$category->name}}" data-cat-id="{{ $category->id }}" >
                            ...
                            <div class="tg-categoryholder">
                                ...
                                <h3><a href="javascript:void()" id>{{ $category->name }}</a></h3>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.20/summernote-bs5.min.js" integrity="sha512-6F1RVfnxCprKJmfulcxxym1Dar5FsT/V2jiEUvABiaEiFWoQ8yHvqRM/Slf0qJKiwin6IDQucjXuolCfCKnaJQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
   ...
   $(document).ready(function(){
        ...
        $(document).on('click', '.tg-category', function(){
            alert()
            // $("#exampleModal .close").click()
            $('#exampleModal').modal('hide');
            $('#change-category-btn').attr('style', 'display: block');
            $('#main-category-text').text($(this).attr('data-cat-name'))
            $('input[name="catid"]').val($(this).attr('data-cat-id'))
        })
