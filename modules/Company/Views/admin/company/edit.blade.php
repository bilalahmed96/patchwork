        ...
        <div class="row">
           @include('Layout::parts.dashboard-sidebar')
            <div class="col-lg-9 col-md-12">
                ...
                <div class="content with-padding">
                 <form method="post" accept-charset="UTF-8" enctype="multipart/form-data" action="{{route('company.admin.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])}}">
                    ...
                    <div class="submit-field">
                      <h5>Name *</h5>
                      <input type="text" class="with-border" id="name" name="name" value="{{ $row->name }}" required="">
                  </div>
                  <div class="submit-field">
                      <h5>Logo</h5>
                ...
                <div class="submit-field">
                    <h5>About Us *</h5>
                    <textarea cols="30" rows="5" class="with-border editor" name="about" required="" style="white-space: pre-line;">{{ $row->about }}</textarea>
                </div>
                
                <div class="submit-field">
                    <h5>Our Company’s Commitment and Work Culture </h5>
                    <textarea cols="30" rows="5" class="with-border" name="work_commitment" required="" style="white-space: pre-line;">{{ $row->work_commitment }}</textarea>
                </div>
                ...
                <div class="submit-field">
                    ...
                    <div class="input-with-icon">
                      <input class="with-border" type="text" name="phone" value="{{ $row->phone }}">
                  ...
                  <div class="submit-field">
                    <h5>Fax</h5>
                    <div class="input-with-icon">
                      <input class="with-border" type="text" name="fax" value="{{ $row->fax }}">
                  ...
                  <div class="submit-field">
                    <h5>Email address</h5>
                    <div class="input-with-icon">
                      <input class="with-border" type="email" name="email" value="{{ $row->email }}">
                  ...
                  <div class="submit-field">
                    ...
                    <div class="input-with-icon">
                      <input class="with-border" type="url" name="website" value="{{ $row->website }}">
                  ...
                  <div class="submit-field">
                    ...
                    @endphp
                    <div class="input-with-icon">
                      <input class="with-border" type="url" name="social_media[facebook]" value="@if(isset($social_media['facebook'])) {{$social_media['facebook'] }} @endif">
                  ...
                  <div class="submit-field">
                    <h5>Twitter</h5>
                    <div class="input-with-icon">
                      <input class="with-border" type="url" name="social_media[twitter]" value=" @if(isset($social_media['twitter'])) {{ $social_media['twitter'] }} @endif">
                  ...
                  <div class="submit-field">
                    <h5>Linkedin</h5>
                    <div class="input-with-icon">
                      <input class="with-border" type="url" name="social_media[linkedin]" value="@if (isset($social_media['linkedin'])) {{ $social_media['linkedin'] }} @endif">
                  ...
                  <div class="submit-field">
                    <h5>Pinterest</h5>
                    <div class="input-with-icon">
                      <input class="with-border" type="url" name="social_media[pinterest]" value="@if( isset($social_media['pinterest'])) {{$social_media['pinterest'] }} @endif">
                  ...
                  <div class="submit-field">
                    <h5>Youtube</h5>
                    <div class="input-with-icon">
                      <input class="with-border" type="url" name="social_media[youtube]" value="@if( isset($social_media['youtube'])) {{$social_media['youtube'] }} @endif">
                  ...
                  <div class="submit-field">
                    <h5>Instagram</h5>
                    <div class="input-with-icon">
                      <input class="with-border" type="url" name="social_media[instagram]" value="@if( isset($social_media['instagram'])) {{$social_media['instagram'] }} @endif">
