...
class Company extends BaseModel
{
    ...
    {
        $meta['seo_title'] = setting_item_with_lang("company_page_list_seo_title", false,null) ?? setting_item_with_lang("company_page_list_title",false, null) ?? __("Candidate");
        $meta['seo_desc'] = setting_item_with_lang("company_page_list_seo_desc");
        $meta['seo_image'] = setting_item("company_page_list_seo_image", null) ?? setting_item("company_page_list_banner", null);
