...
<div class="header-logo flex-shrink-0 bg-white">
    <h3 class="logo-text"><a href="{{url('/admin')}}"> <img src="https://technostaging.com/patchworkhub-laravel/public/images/patchhub-logo.png" style="max-height: 31px;"> </a></h3>
</div>
