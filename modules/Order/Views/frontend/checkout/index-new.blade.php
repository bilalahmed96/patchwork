...
@section('content')
    ...
    <form id="bravo-checkout-page" method="POST"   v-cloak>
<div class="container" style="padding-bottom: 50px">
    ...
    <div class="row">
            ...
            <p class="text-right d-flex align-items-center justify-content-end"> <span class="mr-3 fw-bold" style="">
                ...
                <input type="hidden" name="upgrade" value="19">
                <input type="hidden" name="vat" value="120">
                  <input checked="" id="payment-{{ $k }}" name="payment_gateway" type="radio" value="{{ $k }}" data-name="paypal" style="display:none">
